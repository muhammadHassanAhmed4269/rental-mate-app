...
import PaginatedItems from "../../Components/BrowsingPagination";
const BrowsingPage = () => {
  ...
  return (
    <div>
      ...
      <div className="px-5 grid grid-cols-12 gap-6 mt-4">
        <div className="col-span-3 mb-8 bg-[#D6FFD8] flex flex-col py-10 px-5 gap-5">
          <div className="font-semibold text-[18px] mb-2">Filters</div>
        ...
        <div className="col-span-9 mb-8 bg-[#D6FFD8] px-8 pt-5 pb-0 flex flex-col gap-5">
